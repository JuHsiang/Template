...
define(['app/config/option/service',
    'util/message',
    'util/validator'
], function (optionService, message, validator) {
    var optionGridVm;
    ...
    var optionVm = avalon.define({
        ...
        $selectOptOptionTypes: {
            url: "/ListOption/GetListOptionTypeCombobox",
            onInit: function (vm) {
                optionTypesSelVm = vm;
            },
        ...
        $gridOpt: {
            ...
            loadData: function (page) {
                optionVm.searchDto.PagerDto.PageIndex = page;
                var searchInput = JSON.stringify(optionVm.searchDto.$model);
                return optionService.getOptions(searchInput);
            },
            onInit: function (vm) {
                optionGridVm = vm;
            }
        ...
        save: function () {
            ...
            if (res) {
                var dto = JSON.stringify(optionVm.dto.$model);
                optionService.saveOption(dto).done(function () {
