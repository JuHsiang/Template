...
define(['app/sys/user/service',
    'util/message',
    'util/validator'
], function (userService, message, validator) {
    var usersGridVm;
    ...
    var sysUserVm = avalon.define({
        ...
        $gridOpt: {
            ...
            loadData: function (page) {
                sysUserVm.searchDto.PagerDto.PageIndex = page;
                var searchInput = JSON.stringify(sysUserVm.searchDto.$model);
                return userService.getSysUsers(searchInput);
            },
            onInit: function (vm) {
                usersGridVm = vm;
            }
        ...
        save: function () {
            ...
            if (res) {
                var dto = JSON.stringify(sysUserVm.userDto.$model);
