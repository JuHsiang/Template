...
namespace Web.Portal.Controllers
{
    ...
    public class SysRoleController : BaseController
    {
        ...
        /// 功能业务逻辑
        /// </summary>
        private readonly SysFuncMgtService funcMgtService;
        ...
        public SysRoleController()
        {
            ...
            this.funcMgtService = IocManager.Instance.Resolve<SysFuncMgtService>();
        }
        ...
        [HttpGet]
        public JsonResult GetSysRoleList([FromJson]SysRoleSearch searchInput)
        {
            var result = this.roleMgtService.GetSysRoleList(searchInput);
        ...
        {
            var result = this.roleMgtService.GetSysRoleInfo(id);
        ...
        {
            this.roleMgtService.AddOrUpdate(dto);
        }
        ...
        public ActionResult GetFullSysFuncs(int? sysRoleId)
        {
            ...
            {
                curSysRoleFuncs = this.roleMgtService.GetSysRoleInfo(sysRoleId.Value).
                    SysFuncs.Select(p => p.Id).ToList();
            }

            var result = new List<JsTreeNode>();
            var funcList = this.funcMgtService.GetMenuFuncList().OrderBy(p => p.OrderNumber).ToList();
        ...
        {
            var result = this.roleMgtService.GetSysRoleCombobox();
