//------------------------------------------------------------
// <copyright file="BaseOrg.cs" company="WIKI Tec">
//     WIKI Tec copyright.
// </copyright>
// <author>周夏龙</author>
// <date>2016/3/8 8:54:17</date>
// <summary>
//  主要功能有：
//  
// </summary>
...
namespace Wikitec.Domain
{
    ...
    /// Domain基类(包含OrgId)
    /// </summary>
    public abstract class BaseOrg : OrgEntity<long>, ICreationAudited<SysUser>, IModificationAudited<SysUser>, ISoftDelete
    {
        /// <summary>
        /// 创建时间
        /// </summary>
