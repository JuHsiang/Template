//------------------------------------------------------------
// <copyright file="BaseWithOrgId.cs" company="WIKI Tec">
//     WIKI Tec copyright.
// </copyright>
// <author>张宇</author>
// <date>2016/3/8 9:04:44</date>
// <summary>
//  主要功能有：
//  包含机构Id的基类
// </summary>
...
namespace Wikitec.Domain
{
    ...
    /// 包含机构Id的基类
    /// </summary>
    public class BaseWithOrgId : OrgEntity<int>, ICreationAudited<SysUser>, IModificationAudited<SysUser>, ISoftDelete
    {
        /// <summary>
        /// 创建时间
        /// </summary>
